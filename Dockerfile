...
# Pre-install logrus at Go 1.17 compatible version before go get pulls latest
RUN git clone --depth 1 --branch v1.9.3 https://github.com/sirupsen/logrus.git ${GOPATH}/src/github.com/sirupsen/logrus
