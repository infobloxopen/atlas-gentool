...
# Manually install jsonschema deps at Go 1.17 compatible versions
# (go get in GOPATH mode fetches HEAD which now requires Go 1.21+)
RUN git clone --depth 1 --branch v0.0.0-20210918223802-a1d3f4b43d7b https://github.com/alecthomas/jsonschema.git ${GOPATH}/src/github.com/alecthomas/jsonschema 2>/dev/null || \
    (cd ${GOPATH}/src/github.com/alecthomas/jsonschema && git fetch && git checkout v0.0.0-20210918223802-a1d3f4b43d7b) ; \
    git clone --depth 1 --branch v0.2.0 https://github.com/iancoleman/orderedmap.git ${GOPATH}/src/github.com/iancoleman/orderedmap 2>/dev/null; \
    ...
    git clone --depth 1 https://github.com/xeipuuv/gojsonschema.git ${GOPATH}/src/github.com/xeipuuv/gojsonschema 2>/dev/null; \
    git clone --depth 1 https://github.com/xeipuuv/gojsonreference.git ${GOPATH}/src/github.com/xeipuuv/gojsonreference 2>/dev/null; \
    git clone --depth 1 https://github.com/xeipuuv/gojsonpointer.git ${GOPATH}/src/github.com/xeipuuv/gojsonpointer 2>/dev/null; \
    git clone --depth 1 --branch v1.27.1 https://github.com/protocolbuffers/protobuf-go.git ${GOPATH}/src/google.golang.org/protobuf 2>/dev/null; \
    true
