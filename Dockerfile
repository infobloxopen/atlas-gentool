...
RUN rm -rf ${GOPATH}/src/github.com/sirupsen/logrus && \
    ...
    git clone https://github.com/alecthomas/jsonschema.git ${GOPATH}/src/github.com/alecthomas/jsonschema && \
    cd ${GOPATH}/src/github.com/alecthomas/jsonschema && git checkout a1d3f4b43d7b && \
    git clone --depth 1 --branch v0.2.0 https://github.com/iancoleman/orderedmap.git ${GOPATH}/src/github.com/iancoleman/orderedmap && \
    git clone --depth 1 https://github.com/xeipuuv/gojsonschema.git ${GOPATH}/src/github.com/xeipuuv/gojsonschema && \
    git clone --depth 1 https://github.com/xeipuuv/gojsonreference.git ${GOPATH}/src/github.com/xeipuuv/gojsonreference && \
    git clone --depth 1 https://github.com/xeipuuv/gojsonpointer.git ${GOPATH}/src/github.com/xeipuuv/gojsonpointer && \
    git clone --depth 1 --branch v1.27.1 https://github.com/protocolbuffers/protobuf-go.git ${GOPATH}/src/google.golang.org/protobuf && \
    git clone --depth 1 --branch v0.15.0 https://github.com/golang/sys.git ${GOPATH}/src/golang.org/x/sys
